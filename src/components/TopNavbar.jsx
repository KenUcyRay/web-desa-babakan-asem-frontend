  ...
  export default function TopNavbar() {
    ...
    return (
      <div className="w-full sticky top-[32px] bg-white dark:bg-gray-900 shadow z-40 transition-colors">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-1 text-sm font-medium text-gray-700 dark:text-gray-200">
          ...
          {/* ✅ Sosmed + Toggle Dark Mode */}
          <div className="flex items-center gap-4">
            <a
              href="https://www.facebook.com/PrabowoSubianto/?locale=id_ID"
              target="_blank"
