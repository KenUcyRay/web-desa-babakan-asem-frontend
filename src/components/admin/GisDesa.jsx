      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            <span className="text-green-600">🗺️ Sistem Informasi</span>{" "}
            Geografis
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Peta digital wilayah Desa Babakan Asem dengan informasi geografis
            dan administratif yang lengkap
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 border-b">
            ...
            <p className="text-gray-600 mt-2">
              Peta detail pembagian wilayah administratif desa
            </p>
          </div>
          ...
          <div className="p-6">
            <div className="flex justify-center">
              <img
                ...
                className="max-w-full h-auto rounded-xl shadow-lg border-2 border-gray-100 hover:shadow-xl transition-shadow duration-300"
              />
            </div>
          </div>
        </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Wilayah ini memiliki kontur datar hingga sedikit berbukit,
                  serta dilalui oleh beberapa jalur irigasi dan akses jalan desa
                  yang menghubungkan antar dusun.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Secara administratif, desa ini terbagi menjadi beberapa dusun
                  dan RT/RW, serta memiliki fasilitas umum seperti kantor desa,
                  sekolah dasar, masjid, dan lapangan olahraga.
                </p>
                <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-400">
                  <p className="text-sm text-green-800">
                    <strong>Tips:</strong> Klik pada area peta interaktif di
                    atas untuk melihat informasi detail wilayah.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="text-center text-gray-500 text-sm">
          ...
          <p className="mt-2">
            © {new Date().getFullYear()} Sistem Informasi Geografis Desa Babakan
            Asem
          </p>
        </div>
      </div>
