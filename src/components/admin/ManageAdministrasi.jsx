...
export default function ManageSuratPengantar() {
  ...
  const handleTerima = async (idx) => {
    ...
    try {
      ...
      alertError("Gagal memproses surat pengantar");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      alertError("Gagal memuat data surat pengantar");
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="relative inline-block">
            ...
            <div className="relative bg-white rounded-2xl p-6 border border-green-100 shadow-lg">
              ...
              <p className="text-gray-600 mt-2">
                Kelola permohonan surat pengantar dari masyarakat
              </p>
            </div>
          </div>
        </div>
